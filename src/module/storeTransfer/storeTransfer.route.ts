...
export class StoreTransferRouter {
  ...
  constructor(@inject(STORE_TRANSFER_TYPES.Controller) controller: StoreTransferController) {
    this.router.get(
      "/",
    ...
    this.router.post(
      "/:id/export",
      permissionMiddleware("storeTransfer", "complete"),
      controller.exportTransfer,
    );
    this.router.post(
      "/:id/import",
      permissionMiddleware("storeTransfer", "complete"),
      controller.importTransfer,
    );
    this.router.post(
      "/:id/cancel",
      permissionMiddleware("storeTransfer", "update"),
